  ...
  framePtr = F;
    ...
    Label2: {
      ...
      Label3: {
        F.line = 129;
          Label4: while (true) {
          if (!(i_671088896 < n_p3)) break Label4;
            F.line = 50;
            F.filename = "digitsutils.nim";
            iHEX60gensym4_301990110 = i_671088896;
            F.line = 47;
            ...
            F.line = 131;
            F.filename = "iterators_1.nim";
            i_671088896 = addInt(i_671088896, 1);
          }
      };
    };
  framePtr = F.prev;
...
function auxWriteStackTrace__system_u2084(f_p0) {
  var result_33556518 = [[]];
    ...
    Label5: {
      var j_33556562 = 0;
      var colontmp__671088888 = 0;
      colontmp__671088888 = (i_33556527 - 1);
      var res_671088890 = colontmp__671088888;
      Label6: {
          Label7: while (true) {
          if (!(0 <= res_671088890)) break Label7;
            j_33556562 = res_671088890;
...
function HEX3DHEX3D__jscore95examples951_u14(x_p0, y_p1) {
  ...
  BeforeRet: {
    ...
    var sameObject_671088666 = false;
    F.line = 327;
    sameObject_671088666 = x_p0 === y_p1;
    if (sameObject_671088666) {
    F.line = 328;
    result_671088658 = true;
    break BeforeRet;
    }
    
    if (!(((x_p0).length == (y_p1).length))) {
    F.line = 331;
    result_671088658 = false;
    break BeforeRet;
    }
    ...
    Label1: {
      ...
      F.line = 81;
      F.filename = "iterators_1.nim";
      var colontmp__671088881 = 0;
      F.line = 333;
      F.filename = "comparisons.nim";
      colontmp__671088881 = subInt((x_p0).length, 1);
      F.line = 96;
      F.filename = "iterators_1.nim";
      var res_671088883 = 0;
      Label2: {
        F.line = 97;
          Label3: while (true) {
          if (!(res_671088883 <= colontmp__671088881)) break Label3;
            F.line = 333;
            F.filename = "comparisons.nim";
            i_671088680 = res_671088883;
            if (!((x_p0[chckIndx(i_671088680, 0, (x_p0).length - 1)] == y_p1[chckIndx(i_671088680, 0, (y_p1).length - 1)]))) {
            F.line = 335;
            result_671088658 = false;
            break BeforeRet;
            }
            ...
            F.line = 102;
            F.filename = "iterators_1.nim";
            res_671088883 = addInt(res_671088883, 1);
          }
      };
    };
    F.line = 337;
...
function HEX3DHEX3D__jscore95examples951_u72(x_p0, y_p1) {
  ...
  BeforeRet: {
    ...
    Label1: {
      ...
      F.line = 81;
      F.filename = "iterators_1.nim";
      var colontmp__671088902 = 0;
      F.line = 333;
      F.filename = "comparisons.nim";
      colontmp__671088902 = subInt((x_p0).length, 1);
      F.line = 96;
      F.filename = "iterators_1.nim";
      var res_671088903 = 0;
      Label2: {
        F.line = 97;
          Label3: while (true) {
          if (!(res_671088903 <= colontmp__671088902)) break Label3;
            F.line = 333;
            F.filename = "comparisons.nim";
            i_671088738 = res_671088903;
            if (!((x_p0[chckIndx(i_671088738, 0, (x_p0).length - 1)] == y_p1[chckIndx(i_671088738, 0, (y_p1).length - 1)]))) {
            F.line = 335;
            result_671088716 = false;
            break BeforeRet;
            }
            ...
            F.line = 102;
            F.filename = "iterators_1.nim";
            res_671088903 = addInt(res_671088903, 1);
          }
      };
    };
    F.line = 337;
...
F.line = 145;
F.filename = "jscore.nim";
var arrai_738197511 = [[1, 2, 3]];
if (!((arrai_738197511[0].shift() == 1))) {
F.line = 145;
...
if (!(HEX3DHEX3D__jscore95examples951_u72(arrai_738197511[0], [2, 3]))) {
F.line = 145;
