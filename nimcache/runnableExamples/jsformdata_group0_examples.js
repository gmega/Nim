  ...
  framePtr = F;
    ...
    Label2: {
      ...
      Label3: {
        F.line = 129;
          Label4: while (true) {
          if (!(i_671088696 < n_p3)) break Label4;
            F.line = 50;
            F.filename = "digitsutils.nim";
            iHEX60gensym4_301990110 = i_671088696;
            F.line = 47;
            ...
            F.line = 131;
            F.filename = "iterators_1.nim";
            i_671088696 = addInt(i_671088696, 1);
          }
      };
    };
  framePtr = F.prev;
...
function auxWriteStackTrace__system_u2084(f_p0) {
  var result_33556518 = [[]];
    ...
    Label5: {
      var j_33556562 = 0;
      var colontmp__671088688 = 0;
      colontmp__671088688 = (i_33556527 - 1);
      var res_671088690 = colontmp__671088688;
      Label6: {
          Label7: while (true) {
          if (!(0 <= res_671088690)) break Label7;
            j_33556562 = res_671088690;
...
var data_671088643 = new FormData();
F.line = 61;
data_671088643.set("key0", "value0");
F.line = 61;
data_671088643.append("key1", "value1");
F.line = 61;
data_671088643.delete("key1");
if (!(data_671088643.has("key0"))) {
F.line = 61;
...
if (!((data_671088643.get("key0") == "value0"))) {
F.line = 61;
...
F.line = 61;
(() => { const frmdt = data_671088643; Array.from(frmdt.keys()).forEach((key) => frmdt.delete(key)) })();
if (!((Array.from(data_671088643.entries()).length == 0))) {
F.line = 61;
