...
var NTI671088731 = {size: 0, kind: 18, base: null, node: null, finalizer: null};
var NTI671088697 = {size: 0, kind: 18, base: null, node: null, finalizer: null};
...
var NNI671088697 = {kind: 2, len: 2, offset: 0, typ: null, name: null, sons: [{kind: 1, offset: "Field0", len: 0, typ: NTI33554450, name: "Field0", sons: null}, 
{kind: 1, offset: "Field1", len: 0, typ: NTI33554450, name: "Field1", sons: null}]};
NTI671088697.node = NNI671088697;
var NNI671088731 = {kind: 2, len: 2, offset: 0, typ: null, name: null, sons: [{kind: 1, offset: "Field0", len: 0, typ: NTI33554450, name: "Field0", sons: null}, 
{kind: 1, offset: "Field1", len: 0, typ: NTI33554450, name: "Field1", sons: null}]};
NTI671088731.node = NNI671088731;
  ...
  framePtr = F;
    ...
    Label2: {
      ...
      Label3: {
        F.line = 129;
          Label4: while (true) {
          if (!(i_671088901 < n_p3)) break Label4;
            F.line = 50;
            F.filename = "digitsutils.nim";
            iHEX60gensym4_301990110 = i_671088901;
            F.line = 47;
            ...
            F.line = 131;
            F.filename = "iterators_1.nim";
            i_671088901 = addInt(i_671088901, 1);
          }
      };
    };
  framePtr = F.prev;
...
function auxWriteStackTrace__system_u2084(f_p0) {
  var result_33556518 = [[]];
    ...
    Label5: {
      var j_33556562 = 0;
      var colontmp__671088893 = 0;
      colontmp__671088893 = (i_33556527 - 1);
      var res_671088895 = colontmp__671088893;
      Label6: {
          Label7: while (true) {
          if (!(0 <= res_671088895)) break Label7;
            j_33556562 = res_671088895;
...
function HEX3DHEX3D__jsheaders95examples951_u13(x_p0, y_p1) {
  ...
  BeforeRet: {
    ...
    var sameObject_671088665 = false;
    F.line = 327;
    sameObject_671088665 = x_p0 === y_p1;
    if (sameObject_671088665) {
    F.line = 328;
    result_671088657 = true;
    break BeforeRet;
    }
    
    if (!(((x_p0).length == (y_p1).length))) {
    F.line = 331;
    result_671088657 = false;
    break BeforeRet;
    }
    ...
    Label1: {
      ...
      F.line = 81;
      F.filename = "iterators_1.nim";
      var colontmp__671088907 = 0;
      F.line = 333;
      F.filename = "comparisons.nim";
      colontmp__671088907 = subInt((x_p0).length, 1);
      F.line = 96;
      F.filename = "iterators_1.nim";
      var res_671088909 = 0;
      Label2: {
        F.line = 97;
          Label3: while (true) {
          if (!(res_671088909 <= colontmp__671088907)) break Label3;
            F.line = 333;
            F.filename = "comparisons.nim";
            i_671088679 = res_671088909;
            if (!((x_p0[chckIndx(i_671088679, 0, (x_p0).length - 1)] == y_p1[chckIndx(i_671088679, 0, (y_p1).length - 1)]))) {
            F.line = 335;
            result_671088657 = false;
            break BeforeRet;
            }
            ...
            F.line = 102;
            F.filename = "iterators_1.nim";
            res_671088909 = addInt(res_671088909, 1);
          }
      };
    };
    F.line = 337;
...
function HEX3DHEX3D__jsheaders95examples951_u72(x_p0, y_p1) {
  ...
  BeforeRet: {
    F.line = 326;
    F.filename = "comparisons.nim";
    var sameObject_671088724 = false;
    F.line = 327;
    sameObject_671088724 = x_p0 === y_p1;
    if (sameObject_671088724) {
    F.line = 328;
    result_671088716 = true;
    break BeforeRet;
    }
    
    if (!(((x_p0).length == (y_p1).length))) {
    F.line = 331;
    result_671088716 = false;
    break BeforeRet;
    }
    ...
    Label1: {
      ...
      F.line = 81;
      F.filename = "iterators_1.nim";
      var colontmp__671088912 = 0;
      F.line = 333;
      F.filename = "comparisons.nim";
      colontmp__671088912 = subInt((x_p0).length, 1);
      F.line = 96;
      F.filename = "iterators_1.nim";
      var res_671088913 = 0;
      Label2: {
        F.line = 97;
          Label3: while (true) {
          if (!(res_671088913 <= colontmp__671088912)) break Label3;
            F.line = 333;
            F.filename = "comparisons.nim";
            i_671088738 = res_671088913;
            if (!(HEX3DHEX3D__jsheaders95examples951_u99(x_p0[chckIndx(i_671088738, 0, (x_p0).length - 1)], y_p1[chckIndx(i_671088738, 0, (y_p1).length - 1)]))) {
            F.line = 335;
            result_671088716 = false;
            break BeforeRet;
            }
            ...
            F.line = 102;
            F.filename = "iterators_1.nim";
            res_671088913 = addInt(res_671088913, 1);
          }
      };
    };
    F.line = 337;
...
Label1: {
  ...
  var header_671088643 = new Headers();
  F.line = 51;
  header_671088643.append("key", "value");
  if (!(header_671088643.has("key"))) {
  F.line = 51;
  ...
  if (!(HEX3DHEX3D__jsheaders95examples951_u13(Array.from(header_671088643.keys()), ["key"]))) {
  F.line = 51;
  ...
  if (!(HEX3DHEX3D__jsheaders95examples951_u13(Array.from(header_671088643.values()), ["value"]))) {
  F.line = 51;
  ...
  if (!((header_671088643.get("key") == "value"))) {
  F.line = 51;
  ...
  F.line = 51;
  header_671088643.set("other", "another");
  if (!((header_671088643.get("other") == "another"))) {
  F.line = 51;
  ...
  if (!(HEX3DHEX3D__jsheaders95examples951_u72(Array.from(header_671088643.entries()), [nimCopy(null, {Field0: "key", Field1: "value"}, NTI671088697), nimCopy(null, {Field0: "other", Field1: "another"}, NTI671088697)]))) {
  F.line = 51;
  ...
  if (!((JSON.stringify(Array.from(header_671088643.entries())) == "[[\"key\",\"value\"],[\"other\",\"another\"]]"))) {
  F.line = 51;
  ...
  F.line = 51;
  header_671088643.delete("other");
  if (!(HEX3DHEX3D__jsheaders95examples951_u72(Array.from(header_671088643.entries()), [nimCopy(null, {Field0: "key", Field1: "value"}, NTI671088731)]))) {
  F.line = 51;
  ...
  F.line = 51;
  (() => { const header = header_671088643; Array.from(header.keys()).forEach((key) => header.delete(key)) })();
  if (!(HEX3DHEX3D__jsheaders95examples951_u72(Array.from(header_671088643.entries()), []))) {
  F.line = 51;
  ...
  if (!((Array.from(header_671088643.entries()).length == 0))) {
  F.line = 51;
...
Label2: {
  F.line = 51;
  var header_671088790 = new Headers();
  F.line = 51;
  header_671088790.append("key", "a");
  F.line = 51;
  header_671088790.append("key", "b");
  F.line = 51;
  header_671088790.append("key", "c");
  if (!((header_671088790.get("key") == "a, b, c"))) {
  F.line = 51;
  ...
  F.line = 51;
  header_671088790.set("key", "value");
  if (!((header_671088790.get("key") == "value"))) {
  F.line = 51;
...
Label3: {
  F.line = 51;
  var header_671088801 = new Headers();
  F.line = 51;
  header_671088801.set("key", "a");
  F.line = 51;
  header_671088801.set("key", "b");
  if (!((header_671088801.get("key") == "b"))) {
  F.line = 51;
