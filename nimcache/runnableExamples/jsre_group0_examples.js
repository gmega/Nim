  ...
  framePtr = F;
    ...
    Label2: {
      ...
      Label3: {
        F.line = 129;
          Label4: while (true) {
          if (!(i_671088670 < n_p3)) break Label4;
            F.line = 50;
            F.filename = "digitsutils.nim";
            iHEX60gensym4_301990110 = i_671088670;
            F.line = 47;
            ...
            F.line = 131;
            F.filename = "iterators_1.nim";
            i_671088670 = addInt(i_671088670, 1);
          }
      };
    };
  framePtr = F.prev;
...
function auxWriteStackTrace__system_u2084(f_p0) {
  var result_33556518 = [[]];
    ...
    Label5: {
      var j_33556562 = 0;
      var colontmp__671088662 = 0;
      colontmp__671088662 = (i_33556527 - 1);
      var res_671088664 = colontmp__671088662;
      Label6: {
          Label7: while (true) {
          if (!(0 <= res_671088664)) break Label7;
            j_33556562 = res_671088664;
...
F.line = 56;
F.filename = "jsre.nim";
var jsregex_671088643 = new RegExp("bc$", "i");
if (!(contains__jsZjsre_u51("abc", jsregex_671088643))) {
F.line = 56;
...
if (!(!(contains__jsZjsre_u51("abcd", jsregex_671088643)))) {
F.line = 56;
...
if (!(contains__jsZjsre_u51("xabc", jsregex_671088643))) {
F.line = 56;
...
function startsWith__jsZjsre_u55(pattern_p0, self_p1) {
  var result_687865914 = false;

  var F = {procname: "jsre.startsWith", prev: framePtr, filename: "/home/runner/work/Nim/Nim/lib/js/jsre.nim", line: 0};
  framePtr = F;
    F.line = 64;
    F.filename = "jsre.nim";
    result_687865914 = contains__jsZjsre_u51(pattern_p0, new RegExp(toJSStr(([94]).concat(cstrToNimstr(self_p1.source))), self_p1.flags));
  framePtr = F.prev;
...
F.line = 65;
F.filename = "jsre.nim";
var jsregex_704643075 = new RegExp("abc", "i");
if (!(startsWith__jsZjsre_u55("abcd", jsregex_704643075))) {
F.line = 65;
...
function endsWith__jsZjsre_u75(pattern_p0, self_p1) {
  var result_687865934 = false;

  var F = {procname: "jsre.endsWith", prev: framePtr, filename: "/home/runner/work/Nim/Nim/lib/js/jsre.nim", line: 0};
  framePtr = F;
    F.line = 71;
    F.filename = "jsre.nim";
    result_687865934 = contains__jsZjsre_u51(pattern_p0, new RegExp(toJSStr((cstrToNimstr(self_p1.source)).concat([36])), self_p1.flags));
  framePtr = F.prev;
...
F.line = 72;
F.filename = "jsre.nim";
var jsregex_721420291 = new RegExp("bcd", "i");
if (!(endsWith__jsZjsre_u75("abcd", jsregex_721420291))) {
F.line = 72;
...
function HEX3DHEX3D__jsre95examples954_u13(x_p0, y_p1) {
  ...
  BeforeRet: {
    ...
    var sameObject_738197529 = false;
    F.line = 327;
    sameObject_738197529 = x_p0 === y_p1;
    if (sameObject_738197529) {
    F.line = 328;
    result_738197521 = true;
    break BeforeRet;
    }
    
    if (!(((x_p0).length == (y_p1).length))) {
    F.line = 331;
    result_738197521 = false;
    break BeforeRet;
    }
    ...
    Label1: {
      ...
      F.line = 81;
      F.filename = "iterators_1.nim";
      var colontmp__738197682 = 0;
      F.line = 333;
      F.filename = "comparisons.nim";
      colontmp__738197682 = subInt((x_p0).length, 1);
      F.line = 96;
      F.filename = "iterators_1.nim";
      var res_738197684 = 0;
      Label2: {
        F.line = 97;
          Label3: while (true) {
          if (!(res_738197684 <= colontmp__738197682)) break Label3;
            F.line = 333;
            F.filename = "comparisons.nim";
            i_738197543 = res_738197684;
            if (!((x_p0[chckIndx(i_738197543, 0, (x_p0).length - 1)] == y_p1[chckIndx(i_738197543, 0, (y_p1).length - 1)]))) {
            F.line = 335;
            result_738197521 = false;
            break BeforeRet;
            }
            ...
            F.line = 102;
            F.filename = "iterators_1.nim";
            res_738197684 = addInt(res_738197684, 1);
          }
      };
    };
    F.line = 337;
...
function HEX24__jsZjsre_u48(self_p0) {
  var result_687865906 = [];

  var F = {procname: "jsre.$", prev: framePtr, filename: "/home/runner/work/Nim/Nim/lib/js/jsre.nim", line: 0};
  framePtr = F;
    F.line = 52;
    F.filename = "jsre.nim";
    result_687865906 = nimCopy(null, cstrToNimstr(self_p0.toString()), NTI33554449);
  framePtr = F.prev;

  return result_687865906;
...
function HEX3Aanonymous__jsre95examples954_u88(m_p0) {
  ...
  framePtr = F;
    ...
    result_738197594 = toJSStr((cstrToNimstr(m_p0[chckIndx(0, 0, (m_p0).length - 1)])).concat(HEX24__systemZdollars_u14((m_p0).length)));
  framePtr = F.prev;
...
F.line = 78;
F.filename = "jsre.nim";
var jsregex_738197507 = new RegExp("\\s+", "i");
F.line = 78;
jsregex_738197507.compile("\\w+", "i");
if (!(contains__jsZjsre_u51("nim javascript", jsregex_738197507))) {
F.line = 78;
...
if (!(HEX3DHEX3D__jsre95examples954_u13((jsregex_738197507.exec("nim javascript") || []), ["nim"]))) {
F.line = 78;
...
if (!((jsregex_738197507.toString() == "/\\w+/i"))) {
F.line = 78;
...
F.line = 78;
jsregex_738197507.compile("[0-9]", "i");
if (!(contains__jsZjsre_u51("0123456789abcd", jsregex_738197507))) {
F.line = 78;
...
if (!(eqStrings(HEX24__jsZjsre_u48(jsregex_738197507), [47,91,48,45,57,93,47,105]))) {
F.line = 78;
...
F.line = 78;
jsregex_738197507.compile("abc", "i");
if (!(startsWith__jsZjsre_u55("abcd", jsregex_738197507))) {
F.line = 78;
...
if (!(endsWith__jsZjsre_u75("dabc", jsregex_738197507))) {
F.line = 78;
...
F.line = 78;
jsregex_738197507.compile("\\d", "i");
if (!(HEX3DHEX3D__jsre95examples954_u13(("do1ne".split(jsregex_738197507) || []), ["do", "ne"]))) {
F.line = 78;
...
F.line = 78;
jsregex_738197507.compile("[lw]", "i");
if (!(("hello world".replace(jsregex_738197507, "X") == "heXlo world"))) {
F.line = 78;
...
F.line = 78;
jsregex_738197507.compile("([a-z])\\1*", "g");
...
if (!(("abbcccdddd".replace(jsregex_738197507, Temporary2) == "a1b2c3d4"))) {
F.line = 78;
...
F.line = 78;
var digitsRegex_738197604 = new RegExp("\\d");
if (!(HEX3DHEX3D__jsre95examples954_u13(("foo".match(digitsRegex_738197604) || []), []))) {
F.line = 78;
